...
`[client]$ ./set_setting.sh <setting> <value>` - Sets the setting to value, e.g. `[client]$ ./set_setting.sh organizr.enable True`

`[client]$ ./get_setting.sh <setting>` - Displays the current setting of value, e.g. `[client]$ ./get_setting.sh organizr.enable`
