...
# MIGRATION v0.7
	@./migrate_vault.sh
# ENDMIGRATION
	@./docker_helper.sh ansible-playbook --extra-vars="@vault_migration.yml" --extra-vars="@settings/config.yml" --extra-vars="@settings/vault.yml" -i config_inventory playbook.config.yml
